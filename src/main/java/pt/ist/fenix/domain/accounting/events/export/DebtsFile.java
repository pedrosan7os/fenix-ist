...
import pt.ist.fenixedu.domain.accounting.events.export.DebtsFile_Base;
...
public abstract class DebtsFile extends DebtsFile_Base {
    ...
    static {
        ...
        DESTINATION_INSTITUTION_ID = FenixIstConfiguration.getConfiguration().getSibsDestinationInstitutionId();
    }
